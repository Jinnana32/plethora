...
<body id="page-top">
  ...
  <header class="sub-masthead">
    ...
    <div class="row">
            <div class="col-md-12">
                <div class="container text-center phr-properties" style = "margin-bottom: 1.5em;">
                        <img src="{{ url("") }}/plethora/storage/app/public//developers/{{ $developer->image }}" class="img-responsive" style = "width:150px; height: 150px; margin-bottom: 1.2em;">

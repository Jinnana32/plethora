    ...
    <div class="container">
            <div class="row">
              ...
              <div class="col-md-8 sub-mast-text sub-mast-info">
                  ...
                  <p><h5 style = "font-size:0.8em!important;">My Public Profile: <a href = "{{ url("") }}/agent/{{ $agent["referral_link"] }}" target = "_blank" style = "color:orange;cursor:pointer;">{{ url("") }}/agent/{{ $agent["referral_link"] }}</a></h5></p>
                  <p><h5 style = "font-size:0.8em!important;">My Referral Link: <a href = "{{ url("") }}/register/{{ $agent["referral_link"] }}" target = "_blank" style = "color:orange;cursor:pointer;" class = "edit-link">{{ url("") }}/register/{{ $agent["referral_link"] }}</a></h5></p>

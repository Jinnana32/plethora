    ...
    <div class="container">
            <div class="row">
              ...
              <div class="col-md-8 sub-mast-text sub-mast-info">
                  ...
                  <p><h5 style = "font-size:0.8em!important;">My Public Profile:
                    <a href = "{{ url("") }}/agent/{{ $agent["referral_link"] }}" target = "_blank" style = "color:orange;cursor:pointer;">{{ url("") }}/agent/{{ $agent["referral_link"] }}</a>
                    <i class = "fa fa-copy fappy" name = "{{ url("") }}/agent/{{ $agent["referral_link"] }}" style = "font-size:1.5em;cursor:pointer;"></i></h5></p>
